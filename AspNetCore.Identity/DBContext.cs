...
public class BusinessDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.ToTable(DatabaseTables.Company.TABLE_NAME); // create table if not exist
            entity.HasKey(e => e.Id); // setting id as primary key
        });
        modelBuilder.Entity<CompanyUser>(entity =>
        {
            entity.ToTable(DatabaseTables.CompanyUsers.TABLE_NAME); // create table if not exist
            ...
            entity.Property(e => e.RoleId).HasColumnName(DatabaseTables.CompanyUsers.ROLE_ID).IsRequired();
        ...
        {
            entity.ToTable(DatabaseTables.CommunityUsers.TABLE_NAME); // create table if not exist
            ...
            entity.Property(e => e.RoleId).HasColumnName(DatabaseTables.CommunityUsers.ROLE_ID).IsRequired();
            entity.HasOne(d => d.CommunityF).WithMany().HasForeignKey(d => d.CommunityId).OnDelete(DeleteBehavior.Cascade);
        });
        modelBuilder.Entity<Community>(entity =>
        {
            entity.ToTable(DatabaseTables.Community.TABLE_NAME);
